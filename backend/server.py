...
# ---------- Public system pulse · Homepage hero feed (Iter 87) ----------
from public_pulse import make_public_pulse_router  # noqa: E402

app.include_router(make_public_pulse_router(db))
