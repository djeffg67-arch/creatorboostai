...
export default function EngagementApplyPage() {
    ...
    const onSubmit = async (e) => {
        ...
        setSubmitting(true);
        try {
            const res = await submitEngagementApplication(form);
            setSubmitted(res);
            toast.success("Application received · under review");
        } catch (err) {
    ...
    if (submitted) {
        return (
            <Layout>
                <section className="relative mx-auto max-w-3xl px-4 py-24 lg:px-8">
                    ...
                    <div className="rounded-md border border-cyan-500/40 bg-gradient-to-b from-cyan-500/10 to-ink-800 p-10 text-center shadow-[0_0_60px_rgba(6,182,212,0.18)]" data-testid="apply-confirmation">
                        ...
                        <h1 className="font-heading mt-3 text-3xl font-semibold text-white sm:text-4xl">
                            Application received.
                        </h1>
                        <p className="mt-4 text-base leading-relaxed text-slate-300">
                            <strong className="text-cyan-300">If qualified, you will receive a private scheduling link</strong> so we can align on scope, timeline, and outcomes on a brief strategy call.
                        </p>
                        <p className="mt-3 text-sm leading-relaxed text-slate-400">
                            Our team reviews every application within 24 hours. This process exists because every engagement we take carries real decision weight — and we only accept work we're confident we can move.
                        </p>
